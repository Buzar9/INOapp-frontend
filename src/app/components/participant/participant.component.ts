...
//   import { QrScannerDodoComponent } from '../qr-scanner/qr-scanner-dodo.component';
//   import { QrData } from '../../utils/QrData';
//   import { ParticipantSendService } from '../../services/participant-send-service';
//   import { HttpClientModule } from '@angular/common/http';
//   import { StartRunRequest } from '../../services/request/StartRunRequest';
//   import { AddCheckpointRequest } from '../../services/request/AddCheckpointRequest';
//   import { FinishRunRequest } from '../../services/request/FinishRunRequest';
//   import { AddPenaltyRequest } from '../../services/request/AddPenaltyRequest';
//   import { InitiateRunRequest } from '../../services/request/InitiateRunRequest';
...
//     standalone: true,
//     imports: [CommonModule, QrScannerDodoComponent, ParticipantMapComponent, ButtonModule, RippleModule],
...
//     constructor(private router: Router, private sendService: ParticipantSendService, private participantState: ParticipantStateService, private networkService: NetworkService,
...
//       const formData = this.participantState.getData();
//       this.nickname = formData.participantName;
//       this.team = formData.participantUnit;
//       this.category = formData.categoryId;

//       if (!this.nickname || !this.team || !this.category) {
//         setTimeout(() => this.router.navigateByUrl('/participant'), 2000);
//       }
...
//     onUserSignUp(data: { nickname: string, team: string, category: string }): void {
//       this.nickname = data.nickname;
//       this.team = data.team;
//       // this.routeName = data.routeName;
//       // dodo runId powinno byc generowane w backend i przesylane w odpowiedzi na initiateRun
