...
// @Component({
//   selector: 'qr-scanner-dodo',
//   templateUrl: './qr-scanner-dodo.component.html',
//   imports: [NgxScannerQrcodeComponent, SafePipe, CommonModule, NgFor, ButtonModule, RippleModule],
// })
// export class QrScannerDodoComponent implements AfterViewInit {
